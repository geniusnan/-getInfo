...
#define qqAppKey             @"1106332043"//新
#define qqAppSecret          @"h7mx5cXC83RKTcRn"

#define wxAppKey             @"wxf28c461e2a321dfc"//
#define wxAppSecret          @"40d7ba5d08470e3c54fce3d783fa6039"//


#define HuanXinAppKey  @"yunmei#testniuniu";

//各种分享
#define APP_KEY @"iG2ffdkYaq8kIjrSfvjMcUrf"
#define REPORT_ID @"d5dd317228"

#define weiboAppKey             @"544447301"
#define weiboAppSecret          @"4ac2a2ab7350c6c5158f4f663b7cdd8f"
#define weiboAppRedirectURI     @"http://csapi.win1234567.com"
